...
- Name: phase0-player.qa.spec.ts >> Phase 0 independent QA — announcement and focus behaviour >> QA-S18 focus is retained near the control the player just used
- Location: scripts/phase0-player.qa.spec.ts:909:7

# Error details

```
Error: focus should not be dumped on <body> after submitting
  ...
  - generic [ref=e4]:
    ...
    - main [ref=e14]:
      - region [ref=e15]:
        ...
        - paragraph [ref=e17]: Account dev-2c98cfe1-f849-4e4c-9487-90d0cba61444 (Local Builder 2c98cf), session expires 8/12/2026, 8:21:13 PM.
      ...
      - region [ref=e20]:
        ...
        - generic [ref=e30]: Reloaded the stored projection from the server.
      - region [ref=e31]:
        - heading "Stored for this account" [level=2] [ref=e32]
        - paragraph [ref=e33]: Projection version 1.
        - list [ref=e34]:
          - listitem [ref=e35]:
            - generic [ref=e36]: focus retention probe
            - text: Sequence 1 · recorded 8/12/2026, 4:21:13 PM · id 8fe3ebad-f600-4cfe-bf16-00e6a9ebc96a
    ...
    - status [ref=e38]: Reloaded the stored projection from the server.
```
