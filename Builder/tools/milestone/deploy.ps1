...
Write-Host "  Open: https://console.cloud.google.com/auth/audience?project=$ProjectId"
Write-Host "  Confirm the project name at the top is $ProjectId."
Write-Host "  Left side: Google Auth platform, then Audience (not Credentials)."
Write-Host "  If Publishing status is Testing, find Test users, click Add users."
Write-Host "  Paste your Gmail, the Codex Gmail, and the Antigravity Gmail. Save."
Write-Host "  If Publishing status is In production, there is no Test users list. Skip this step."
Write-Host ""
